    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_student', models.ForeignKey(verbose_name='\u5b66\u751f\u6240\u5728\u73ed\u7ea7', to='app.Class')),
                ('student_school', models.ForeignKey(verbose_name='\u5b66\u751f\u6240\u5728\u5b66\u6821', to='app.School')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('number', models.CharField(max_length=30, null=True, verbose_name='\u6559\u5e08id')),
                ('name', models.CharField(max_length=50, verbose_name='\u6559\u5e08\u540d\u5b57')),
                ('teach', models.CharField(max_length=50, verbose_name='\u4efb\u6559\u8bfe\u7a0b')),
                ('class_teacher', models.ManyToManyField(to='app.Class', verbose_name='\u6559\u5e08\u6240\u5728\u73ed\u7ea7')),
                ('school_teacher', models.ForeignKey(verbose_name='\u6559\u5e08\u6240\u5728\u5b66\u6821', to='app.School')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='student',
            name='teacher',
            field=models.ForeignKey(verbose_name='\u4efb\u6559\u6559\u5e08', to='app.Teacher', null=True),
        ),
        migrations.AddField(
            model_name='class',
            name='class_school',
            field=models.ForeignKey(verbose_name='\u73ed\u7ea7\u6240\u5728\u5b66\u6821', to='app.School'),
        ),
    ]
